...
Overfitting is bad since you're not focusing on the signal and pattern of interest anymore (i.e., how your DV changes with some IV) and instead you're starting to fit the noise structure (i.e., factors aside from the IVs that influence the DV).
