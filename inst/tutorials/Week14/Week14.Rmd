...
# **Week 14:** Ordination continued & cluster analysis
...
![](https://www.researchgate.net/profile/Seo-Min-Ho/publication/264786798/figure/fig9/AS:392334660390915@1470551280938/Dendrogram-for-hierarchical-clustering-and-nMDS-ordination-plot-for-mesozooplankton_W640.jpg){width="100%"}
...
Some common ones are Jaccard and Sørensen for variables with binary outcomes (e.g., 0s and 1s), chi-square and Bray-Curtis for frequencies of categorical data, and Gower for mixed continuous and categorical data (see pg. 404 in your textbook for more distance metrics, though there are even more than that!).
...
Soil cores with smaller distances will be more similar in terms of their mite species composition and abundances.
...
Lastly, as with PCoA, NMDS can be done on *any* distance matrix.
...
Ordination and cluster analysis are unified by the fact that they both analyze distance matrices, so these two methods analyze identical inputs but display the results in different fashions.
