...
Let's once again create a random sample of 100 normally distributed observations from our population (`mean = 5.5, sd = 0.3`).
...
2. Initiate a `for()` loop, where `i` goes from `1` to the length of the empty vector.
3. Within the curly braces, resample with replacement the vector of 100 normally distributed observations; you can save this to a new object.
