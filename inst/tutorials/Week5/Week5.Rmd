...
What do you think you'll get if you enter `points(x, lm.res$fitted.values + lm.res$residuals, col = "blue")`.
...
points(x, lm.res$fitted.values + lm.res$residuals, col = "blue")
```
