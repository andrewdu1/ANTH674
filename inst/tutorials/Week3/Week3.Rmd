...
# Click "Solution" if you don't remember how to subset
```
...
Take your object of 10,000 normally distributed values, and let's add one large number to it (i.e., `c(x, 10000)` if `x` is your object of 10,000 numbers).
